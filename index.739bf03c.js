...
var _getNewsApiJs = require("./get-news-api.js");
var _makeKeywordJs = require("./make-keyword.js");
...
const renderNews = (articles)=>{
    ...
    if (articles.length > displayedArticles) showMoreButton.style.display = "block";
...
const setupSearchButton = ()=>{
    ...
    btn.addEventListener("click", ()=>{
        const finalKeyword = (0, _makeKeywordJs.getKeyword)("#keyword");
        (0, _getNewsApiJs.getNews)(finalKeyword).then((data)=>{
...
},{"./make-keyword.js":"3YRCU","./get-news-api.js":"6SsCS"}],"3YRCU":[function(require,module,exports,__globalThis) {
...
},{}],"6SsCS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const getNews = (keyword)=>{
    ...
    return fetch(API).then((data)=>data.json()).then((data)=>{
        console.log(data);
        return data;
    });
};
